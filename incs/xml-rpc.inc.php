...
## Modified by Jonas Voss <jonas@verture.net> on 31/01/04
## To work with blogatron (working title).
...
$weblog_name = ". {$domain_name} | {$blog_title} .";
$weblog_url = 'http://'.$domain_name.'';
