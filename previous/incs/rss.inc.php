...
$sql_xml = "SELECT (date - 32400) as xml_date, title, text, name from {$db_name}.entries, {$db_name}.authors where status = '1' AND aid = uid ORDER BY xml_date DESC LIMIT 0,15";
