...
print_header(". {$blog_title} | Tilføj bruger", 'edit', $domain_name, $description, $key_words);
?>
<div id="wrapper">
<div id="top">
<p style="float: right;">Bruger: <?=$_SESSION['aname'];?></p>
<h1 style="color: #595d0c; clear: both;">Administration af <?=$blog_title;?> på http://<?=$domain_name;?>/</h1>
</div>
<?=$edit_menu;?>
<div id="add">
<form action="<?=$_SERVER['PHP_SELF'];?>" method="POST" id="adduser">
<div>
<h1>Tilføj bruger</h1>
